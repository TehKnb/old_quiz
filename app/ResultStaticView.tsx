      ...
      <div className="w-full max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <p className="text-slate-700 mb-6 leading-relaxed max-w-xl">
            ...
            А поки Ви очікуєте — отримайте доступ до закритого Telegram-каналу нашого клубу.
            Всередині — матеріали, розбори та анонси зустрічей, які не публікуємо у відкритих каналах.
          </p>
          {/* BONUS CARD */}
          <div
            className="
